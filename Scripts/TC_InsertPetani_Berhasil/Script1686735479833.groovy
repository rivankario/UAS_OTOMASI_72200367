...
WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Id User_id_user (1)'), 'sukamtowqq')

WebUI.click(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Nama Petani_nama_petani'))

WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Nama Petani_nama_petani'), 'Petani Biasa')

WebUI.setText(findTestObject('InsertPetani/Berhasil/Page_/input_Tanggal Lahir_tanggal_lahir'), '090920018')

WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Nama Istri  Suami_nama_istri'), 'Petani Istri')

WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Alamat Petani_alamat_petani'), 'Petani VIll')
...
WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Nomor Telepon_nomor_telpon'), '081251617232')

WebUI.selectOptionByValue(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/select_SD                                  _d31312'), 
    'SMA', true)

WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Jumlah Lahan_jml_lahan'), '150')
...
WebUI.setText(findTestObject('Object Repository/InsertPetani/Berhasil/Page_/input_Email_email'), 'gamer@gmail.com')
